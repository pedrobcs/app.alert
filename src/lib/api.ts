...
/**
 * Get API base URL from environment or use default (local API route)
 */
const getApiBaseUrl = (): string => {
  // If NEXT_PUBLIC_API_BASE_URL is set, use it (for external backend)
  // Otherwise, use the local Next.js API route
